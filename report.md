...
Parametri: population_size=300, generations=200, max-depth = 4
Problem 1 Training:
...
Prova con più generazioni, continuava a migliorare
Problem 5 Training:
...
Problem 8 Test:
Ci mette 8 ore per runnare:
[Gen 62] Best MSE: 13743496.21902 => (exp(4.621) * exp(x5))


Parametri: population_size=300, generations=200, max-depth = 10
Problem 3 Training:
Best expression found = (((((((x1 + 2.013) + exp(cos(7.315))) + ((x1 - x2) + (x1 - x2))) - (x1 * ((abs(x1) + abs((x1 + x1))) + ((cos(abs(x1)) / exp(cos(3.003))) + abs((x1 + x1)))))) + (x0 * x0)) + -(x2)) + (((((((((x2 + x1) + (-2.812 + x0)) / sqrt((-3.211 + 9.749))) / (x1 - 8.089)) / sin(cos(((x1 - x1) / 0.029)))) / (x2 - x2)) / sqrt(((3.813 + x2) + (0.419 - -6.970)))) / ((abs(9.905) + (-3.487 * 5.682)) + sin(exp((x1 / (x0 + -(0.276))))))) + (x0 * x0))), MSE = 16.207463250092353
Problem 3 Test:
Poi è crashato
[Gen 144] Best MSE: 115.97443 => ((((((((x1 * -8.053) + (x2 * -3.923)) + ((-6.501 * x1) + abs((-8.511 * x0)))) + ((sin(x1) + sin(x1)) + sin(x1))) + (((((sin(-0.235) + sin(-2.067)) + sin(x1)) + sin(x1)) + sin(x1)) + sin(x1))) + ((((sin(x1) + exp((x1 + -8.309))) + sin(x1)) + sin(x1)) + sin(x1))) + (((abs(sin(x0)) + (((sin(x1) + sin(x1)) + sin(x1)) + sin(x1))) + (((sin(x1) + (((x2 + x1) + sin(x1)) + sin(x1))) + (sin(x1) + sin(x1))) + sin(x1))) + sin(x1))) - (((sin(x1) / (x1 - x2)) / ((((sin(-3.471) + sin(x1)) + sin(x1)) / sin(x1)) / ((abs(x2) / -5.266) / ((x1 * -8.053) / 3.492)))) / ((((7.765 - x1) + (x2 + x2)) + (((((6.893 + x2) + sin(x2)) / ((-6.716 + x2) + sin(-5.606))) / (-2.470 + abs(abs(x1)))) / (abs((((x0 + x1) + (-6.627 + x1)) - ((-8.697 * x0) / (x2 + x2)))) + abs((x2 * 1.152))))) + (sin(sin(x2)) + ((((x1 * x1) + (8.709 * 0.504)) + (sin(x1) + (1.281 * x1))) + abs(5.766))))))

Parametri: population_size=300, generations=200, max-depth = 6
Problem 3 Training:
Best expression found = ((8.245 - ((exp(x1) + (abs(x1) + -(x1))) + ((x2 + x2) + ((1.452 + x2) + (x1 + -5.526))))) + (exp(-(x1)) + ((x0 * x0) / sqrt(log10(sqrt(-8.854)))))), MSE = 59.18523682401523

Problem 3 Test:
Best expression found = (((((x1 * -5.880) - x2) + ((x1 * -8.438) + (sin(x1) * (9.342 + 7.489)))) + (x0 * x0)) + (sqrt(((3.386 + -6.650) + (log10(x1) + (x1 + x0)))) + (((-3.231 + x2) + (x0 * x0)) + ((7.715 + x0) - x2)))), MSE = 175.53706995419105
...
![Test 5 Pop 10000 Gen 100 Depth 6](/report_images/test5_pop10000_gen100_depth6.png)

((-8.599 + ((-9.087 + -1.618) * (x1 + 2.066))) / exp(((x1 / x1) * (5.382 * 6.624))))
